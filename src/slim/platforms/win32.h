...
int APIENTRY WinMain(HINSTANCE hInstance,
    ...
    int iPixelFormat = ChoosePixelFormat(win_dc, &pfd);
    SetPixelFormat(win_dc, iPixelFormat, &pfd);
    win_rc = wglCreateContext(win_dc);
    wglMakeCurrent(win_dc, win_rc);
    gladLoadGL();
