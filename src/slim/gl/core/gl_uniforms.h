...
struct GLVector2Uniform : GLUniformLocation {
    explicit GLVector2Uniform(const char* variable_name = nullptr, const char* field_name = nullptr, const char* bases = nullptr, int index = -1) :
        GLUniformLocation{variable_name, field_name, bases, index} {}

    void update(const vec2 &vector) {
